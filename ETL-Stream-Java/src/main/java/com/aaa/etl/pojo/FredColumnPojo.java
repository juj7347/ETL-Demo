...
public class FredColumnPojo {
	...
	@JsonProperty("title")
	private String title; //검색된 series의 title 매핑
	...
	// FRED의 시간대 변수를 실습에 적합한 time 형식으로 역질렬화 하도록 설정
	...
	public String toString() {
		return "FredColumnPojo [id=" + id + ", realtime_start=" + realtime_start + ", realtime_start=" + realtime_start + ", realtime_end=" + realtime_end
				+ ", title=" + title + ", observation_start=" + observation_start + ", observation_end=" + observation_end + ", frequency=" + frequency + ", frequency_short=" + frequency_short
				+ ", units=" + units + ", units_short=" + units_short + ", seasonal_adjustment=" + seasonal_adjustment + ", seasonal_adjustment_short=" + seasonal_adjustment_short
				+ ", last_updated=" + last_updated + ", popularity=" + popularity + ", group_popularity=" + group_popularity + ", notes=" + notes + "]";
	}
