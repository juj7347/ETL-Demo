...
@Getter
@Setter
@JsonPropertyOrder({"realtime_start", "realtime_end", "date", "value", "id", "title", "state", "frequency_short", "units_short", "seasonal_adjustment_short"})
